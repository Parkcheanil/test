...
public class BoardController {
	...
	public void getView(@RequestParam(required = false) String busi_num, Model model)

			throws Exception {

		BoardVO vo = service.view(busi_num);
	...
	public void getModify(@RequestParam(required = false) String busi_num, Model model)
	...
	public String postModify(BoardVO vo) throws Exception {
		...
		return "redirect:/board/view?busi_num=" + vo.getBusi_num();
	}

	// 게시물 삭제
	@RequestMapping(value = "/delete", method = RequestMethod.GET)
	public String getDelete(@RequestParam(required = false) String busi_num) throws Exception {
