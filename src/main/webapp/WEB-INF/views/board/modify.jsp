...
<body>
	...
	<form method="post">
		...
		<label>사업자번호</label> 
		<input type="text" name="busi_num" value="${view.busi_num}" />
		
		<label>약   칭</label>
		<input type="text" name="short_" value="${view.short_}" /><br /> 
		
		<label>거래처명</label> 
		<input type="text" name="custom" value="${view.custom}" /><br />
		
		<label>대 표 자</label> 
		<input type="text" name="ceo"  value="${view.ceo}"  />
		
		<label>담 당 자</label> 
		<input type="text" name="charge_person"  value="${view.charge_person}"  /><br />
